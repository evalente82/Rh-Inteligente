...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260313175714_AddContracheque")]
    partial class AddContracheque
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Contracheque", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("FechamentoFolhaId")
                        .HasColumnType("uuid");

                    b.Property<decimal>("FgtsPatronal")
            ...
            modelBuilder.Entity("Domain.Entities.ItemContracheque", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ContrachequeId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ItensContracheque", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ItemContracheque", b =>
                {
                    b.HasOne("Domain.Entities.Contracheque", "Contracheque")
                        .WithMany("Itens")
                        .HasForeignKey("ContrachequeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Contracheque");
                });
